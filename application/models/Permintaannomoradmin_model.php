...
class Permintaannomoradmin_model extends CI_Model {
    ...
    public function add($post)
    {
        $params=[
            ...
            'ket_verifikator1'=>$post['ket_verifikator1']
        ];
    ...
    public function edit($post)
    {
        $params=[
            ...
            'nama_file'=>$post['nama_file'],
            'ket_verifikator1'=>$post['ket_verifikator1'],
            'verifikator1'=>$post['verifikator1'],
    ...
    public function tambahnomor($post)
    {
        $params=[
            'nomorurut'=>$post['nomorurut'],
            'updated_at'=>date('d-m-Y H:i:s')
        ];
        $this->db->where('id',$post['id']);
        $this->db->update('t_riwayatsurat',$params);
