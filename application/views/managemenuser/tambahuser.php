      ...
      <form action="" method="POST">
        <div class="card-body">
            <div class="form-group <?=form_error('username')?'has-error': null?>">
                ...
                <input type="text" name="username" class="form-control" id="username" placeholder="Isi Username" value="<?= set_value('username') ?>">
            ...
            <div class="form-group <?=form_error('level')?'has-error': null?>">
                ...
                <select name="level" class="form-control">
                    ...
                    <option value="2" <?= set_value('level') == 2 ? "selected" : null?>>Staff</option>
                    <option value="3" <?= set_value('level') == 3 ? "selected" : null?>>Kasi</option>
                    <option value="4" <?= set_value('level') == 4 ? "selected" : null?>>Kabid</option>
                    <option value="5" <?= set_value('level') == 5 ? "selected" : null?>>Sekdin</option>
                    <option value="6" <?= set_value('level') == 6 ? "selected" : null?>>Kadin</option>
                </select>
