                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="<?=site_url('tte')?>" class="btn btn-secondary btn-xs"><i class="fas fa-undo"></i> Kembali</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="col-md-4 offset-md-4">
                            <form action="<?=site_url('tte/prosestte')?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group <?=form_error('tte_oleh')?'has-error': null?>">
                                <label for="tte_oleh">Nama User</label>
                                <input type="text" name="tte_oleh" class="form-control" id="tte_oleh" placeholder="Nama User" value="<?= $this->fungsi->user_login()->nama ?>">
                                <?= form_error('tte_oleh','<div class="text-small text-danger">','</div>') ?>
                            </div>
