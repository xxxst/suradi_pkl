<section class="content">
  <div class="col-md-12">
    ...
    <div class="card card-dark">
      ...
      <form action="<?=site_url('permintaankadin/proses')?>" method="POST" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group <?=form_error('tujuan')?'has-error': null?>">
              ...
              <div class="form-group <?=form_error('nama_file')?'has-error': null?>">
                <label for="ket_verifikator4">Keterangan Revisi</label>
                <textarea type="text" name="ket_verifikator4" class="form-control" id="ket_verifikator3" required placeholder="Keterangan Revisi"><?= $row->ket_verifikator4 ?></textarea>
                <?= form_error('keterangan','<div class="text-small text-danger">','</div>') ?>
              </div>
              <div class="form-group <?=form_error('verifikator4')?'has-error': null?>">
                <label for="verifikator4">Verifikasi</label>
                <select name="verifikator4" id="verifikator4" class="form-control" required>
                    <option value="">- Pilih -</option>
