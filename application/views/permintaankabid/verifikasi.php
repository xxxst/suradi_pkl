                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="<?=site_url('permintaankabid')?>" class="btn btn-secondary btn-xs"><i class="fas fa-undo"></i> Kembali</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="col-md-4 offset-md-4">
                            <form action="<?=site_url('permintaankabid/prosesverifikasi')?>" method="POST" enctype="multipart/form-data">
